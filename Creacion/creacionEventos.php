...
<body>
	...
	<section id="content">
		...
		<main>
            ...
            <br>
            <form method="POST" action="../BasedeDatos/crearEventos.php">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ubicación" name="Ubicación">
                    </div>
                    <div class="col-6 col-sm-3">
                        <label>Notas</label>
                        <textarea type="text" class="form-control" placeholder="Notas" name="Notas"></textarea>
                    </div>
                </div>
				<br>
                <div style="display: grid; place-items: center;">
