	...
	<section id="content">
		...
		<main>
            <div style="display: grid; place-items: center;">
                <h4>Creación de Contacto</h4>
            </div>
            <br>
            <form method="POST" action="../BasedeDatos/crearContactos.php">
                <div class="row">
                    <div class="col-6 col-sm-3">
                        <label>Nombre y Apellido</label>
                        <input type="text" class="form-control" placeholder="Nombre y Apellido" name="nombrecompleto">
                    </div>
                    <div class="col-6 col-sm-3">
                    ...
                    <div class="col-6 col-sm-3">
                        ...
                        <textarea type="text" class="form-control" placeholder="Historial" name="Historial"></textarea>
                    </div>
                </div>
				<br>
                <div style="display: grid; place-items: center;">
