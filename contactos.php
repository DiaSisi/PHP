...
<body>
	...
	<section id="content">
		...
		<main>
            <form method="POST">            
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="nombrecompleto">
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            include "BasedeDatos/buscarContactos.php"
                        ?>
                    </tbody>
                </table>
            </form>
        ...
        <div style="display: grid; place-items: center;">
            <a href="Creacion/creacionContactos.php" class="btn btn-outline-success">Crear</a>
        </div>
